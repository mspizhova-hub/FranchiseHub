// Загальні дані та функції для обох сторінок

// Дані франшиз (приблизні/демонстраційні)
const FRANCHISES = {
  "Кав'ярня": {
    pauschal: 20000,
    basePerM2: { renovation: 120, equipment: 400, furniture: 80 },
...
// Функція для заповнення селектів франшиз на сторінці
function populateFranchiseSelect(selectId){
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  if(el('franchise')){
    populateFranchiseSelect('franchise');
